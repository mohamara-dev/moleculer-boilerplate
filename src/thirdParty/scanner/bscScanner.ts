...
// export default class bscScanner extends EvmScanner{
//   constructor() {
//     super(process.env.BSCSCAN_API_BASE_URL,process.env.BSCSCAN_API_KEY)
//   }


//   public async analyzeStatusResult(merchantWalletAddress: string, customerWalletAddress: string): Promise<statusResult> {
//     try {
//       console.log('analyzing bsc')
...
//         Big.NE = -8
//         Big.DP = 20
//         const symbol = targetTransaction.tokenSymbol ?? 'BNB'
