...
import tokenController from '@ServiceDomain/blockchain/controllers/token.controller'
 ...
 */
  private myController = new tokenController()
  private myControllerShared = tokenController.shared()
  /**
